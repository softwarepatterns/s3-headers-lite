...
///
/// ```
/// use s3_headers_lite::aws_math::get_sha256;
///
...
///
/// ```
/// use s3_headers_lite::aws_math::authorization_query_params_no_sig;
...
pub fn authorization_query_params_no_sig(
    ...
    let mut query_params = query_params_string(
        &signed_headers,
        access_key,
        datetime,
        region,
...
mod tests {
    ...
    fn test_signing() {
        ...
        let canonical_string =
            aws_format::canonical_request_string("GET", &url, &canonical_headers, EXPECTED_SHA);
        ...
        let datetime = Date::from_calendar_date(2013, 5.try_into().unwrap(), 24)
            ...
            .assume_utc();
        let string_to_sign =
            aws_format::string_to_sign(&datetime, "us-east-1", service, &canonical_string);
