...
/// use s3_headers_lite::aws_format::to_short_datetime;
///
...
/// ```
/// use time::OffsetDateTime;
/// use s3_headers_lite::aws_format::to_long_datetime;
///
/// let datetime = OffsetDateTime::from_unix_timestamp(0).unwrap();
...
/// ```
/// use time::OffsetDateTime;
/// use s3_headers_lite::aws_format::credential_scope_string;
///
/// let datetime = OffsetDateTime::from_unix_timestamp(0).unwrap();
...
/// ```
/// use time::OffsetDateTime;
/// use s3_headers_lite::aws_format::string_to_sign;
///
/// let datetime = OffsetDateTime::from_unix_timestamp(0).unwrap();
...
/// ```
/// use url::Url;
/// use s3_headers_lite::aws_format::canonical_uri_string;
///
...
/// Allocates.
fn to_key_value_strings<S: AsRef<str>, T: AsRef<str>>(
    headers: &[(S, T)],
    sep: &str,
) -> Vec<String> {
    headers
...
/// ```
/// use url::Url;
/// use s3_headers_lite::aws_canonical::to_canonical_headers;
/// use s3_headers_lite::aws_format::canonical_request_string;
///
...
///
/// ```
/// use s3_headers_lite::aws_format::security_token_string;
///
...
/// ```
/// use time::OffsetDateTime;
/// use s3_headers_lite::aws_format::query_params_string;
///
/// let datetime = OffsetDateTime::from_unix_timestamp(0).unwrap();
...
mod tests {
    ...
    fn query_params_string_renders_expiry_and_signed_headers() {
        ...
        assert!(result
            .contains("X-Amz-Credential=AKIAEXAMPLE%2F19700101%2Fus-west-2%2Fs3%2Faws4_request"));
    ...
    fn security_token_string_percent_encodes_token() {
        ...
        assert_eq!(
            security_token_string("plain"),
            "&X-Amz-Security-Token=plain"
        );
    }
    ...
    fn canonical_request_orders_headers_alphabetically() {
        ...
        let _url = Url::parse("https://examplebucket.s3.amazonaws.com/k").unwrap();
        let headers = vec![
